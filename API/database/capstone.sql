...
--Great Lakes Reviews
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('13', '6', '5', 'JRybacki from Pennsylvania', 'Just picked up some Great Lakes beer this weekend and this was one of them.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('13', '4', '4', 'UristMcBrewer from Pennsylvania', 'The beer is a medium-dark straw but with a lovely big fluffy head.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('13', '5', '4', 'MNAle from Minnesota', 'A 1+ inch slightly off-white creamy head rising above an up-rushing absolute shower of bubbles.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('14', '6', '5', 'Antg8989 from New Jersey', 'The beer is a deep amber and very transparent with a beige head.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('14', '3', '3', 'Elemental19xx from Illinois', 'Not a bad beer, just leaves a lot to be desired. The smell is pleasant,
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('14', '4', '5', 'Davidstan from Alabama', 'Best amber ever had for me. Very rich with slight heat from alcohol but well hidden.
Caramel and biscuit on the front end and great boozy hint on finish. Well carbonated.', '2021-01-13');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('15', '5', '4', 'beergoot from Colorado', 'Clear, copper-colored body capped with a thick, frothy head. Malty nose with some mild fruitiness to the aroma.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('15', '6', '4', 'taters21 from Ohio', 'Pours a cloudy golden color with a very minimal head that soon disappears into nothing.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('15', '3', '4', 'PhillyJay1701 from Pennsylvania', 'Poured into a Pilsner style glass (cause I felt like it.... 
And had nothing else clean)
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('16', '4', '4', 'realJohnnyHobo from Maryland', 'Very bold and very citrus. This lightly straw colored golden pale ale comes in at 6.5 ABV with over 50 IBU (as printed on the can)
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('16', '5', '4', 'JohnF from Pennsylvania', 'Another good ipa. Thinner taste than commodore perry but a good summer drink.
Light color and less % than CPerry too. India pale ale variety.
Highly recommend for taste.', '2020-10-25');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('16', '6', '4', 'Bluerabbitbell from Pennsylvania', 'Annual trip to GLBC after visiting Isaiah at GJR for the first time.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('17', '3', '4', 'UristMcBrewer from Pennsylvania', 'The beer is a nice goldenrod with a good fizzy head.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('17', '4', '5', 'daliandragon from Maryland', 'Back when BA made everyone choose a favorite style as part of their profile,
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('17', '5', '4', 'secondtooth from Indiana', 'Lightly hazed deep amber appearance with a small off white head
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('18', '6', '4', 'German-Helles from Wisconsin', 'Attractive looking beer; deep brown body, large tan head and very good lacing.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('18', '3', '4', 'laquebrada from California', 'dark brown and pours a nice white head
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('18', '4', '4', 'guckymeister from Cali', 'Small brownish head when poured from 12 oz. bottle.
Opaque dark brown color, aroma of anise, chocolate, cinnamon, roasted malt.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('19', '5', '3', 'Dr_Gonzo from Kentucky', 'A couple of 12 oz. cans fit into a clear glass liter mug, since the head,
...
It took Great Lakes a while to add to the list of hazy beers. They could have done better.', '2020-12-20');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('19', '6', '4', 'GreesyFizeek from New York', 'I got a 6pck of this beer from my local meijer store.
...
The mouthfeel was lighter in body with good carbonation. Overall it is a good beer.', '2020-11-17');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('19', '3', '3', 'superspak from Ohio', 'Pours a syrupy orange with very little head and negligible lacing.
...
Not much punch to this one, loads of pulp, but minimal complexity. Still quite drinkable and solid.', '2020-09-18');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('20', '4', '5', 'ClassicBrad from Pennsylvania', 'Perfection for the style/intent.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('20', '5', '3', 'buschbeer from Ohio', '12 FL. OZ. can
...
I will admit the name says it all. These would be great on a hot summer day after mowing the lawn.', '2021-03-18');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('20', '6', '4', 'DrBeergood from Ohio', 'Straw yellow. Opaque. Moderate carbonation. Glossy surface.
...
Crushable--Beer is made for drinking, therefore, drinkability is key.
Very approachable. Full of real ingredients. Doesnt contain fermentation aids (corn/rice) or extracts. Im glad that Great Lakes is putting out a good quality light brew.
Cleveland has a high quality water supply to boot.', '2021-02-04');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('21', '3', '3', 'teromous from Virginia', 'Poured from a bottle with an Enjoy By date of 3/31/21 into a pint glass.
...
I am a sucker for seasonals so I snatched this up even though it is a little early for Irish.
Will probably buy again if it is available.', '2021-01-07');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('21', '4', '3', 'MonDak_Joe1953 from Minnesota', 'The first beer I have had more than one of in 1 sitting was Smithwicks.
I still love it, but Conway’s gives me the same feeling I did about Smithwicks all those years ago', '2020-12-15');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('21', '5', '4', 'Judgie from Indiana', 'Pours a clear, copper color with a tight head that leaves lots of lacing
...
Overall, a good refreshing brew. I will buy again', '2020-12-03');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('22', '6', '3', 'WesMantooth from Ohio', 'Appearance – This poured a dull, dingy dark brown with an unimpressive head.
...
especially the darker styles like the stouts, but this one missed the mark.', '2021-01-17');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('22', '3', '4', 'Chuckdiesel24 from Illinois', 'Dark brown in color, a bit cloudy. Cream colored head that remains as a thing ring.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('22', '4', '4', 'neenerzig from Ohio', 'Look - clear dark reddish brown with a very slight head that goes away pretty quick
...
Overall - Interesting different twist on a dunkelweizen. Tasty and very complex', '2020-12-16');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('23', '5', '3', 'barnzy78 from Illinois', 'golden with thin white head
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('23', '6', '3', 'bsp77 from Minnesota', 'One of the better mexilagers Ive had.
Pours light gold. Lots of bubbles. Mild aroma. Very good flavor. Strong lime but not overpowering.
Goes down easy. Great summer brew.', '2020-05-26');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('23', '3', '4', 'BB1313 from Ohio', 'This is very well executed and delivers what you would expect.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('24', '4', '4', 'RaulMondesi from California', 'Pours amber with a 1 inch white head. Heavy lacing. Slight haze.
Strong piney aroma, grapefruit, orange.
Taste is pine, grapefruit zest, resin.
Medium bodied, light carbonation. Dry, bitter finish.
Outstanding! One of the better DIPAs Ive had.', '2020-05-10');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('24', '5', '3', 'mothman from Minnesota', 'Has a bronze color with amber highlights and a 1/2 inch head.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('24', '6', '3', 'Dodo2step from Pennsylvania', 'A little sweeter for my tastes. Smooth with minimal hop taste.
More malty but I’m still giving it a good rating for its drinkability. Alcohol taste doesn’t linger.', '2020-05-10');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('25', '3', '4', 'tjwarren from Ohio', 'I am not used to having an aggressive beer from Great Lakes. What a surprise.This is a great beer.
Very hoppy and bitter. Great mouthfeel. The smell seems a bit off to me. Taste is something else though.', '2020-05-11');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('25', '4', '1', 'SaltofOH from Ohio', 'I love Great Lakes, but this beer taught me I am not a fan at all of Red Ales.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('25', '5', '3', 'superspak from Ohio', 'Pours a clear reddish-brown color with plenty of head.
...
The feel is not heavy at all. Overall I think that this is a great summertime brew that I hope to enjoy more of', '2020-03-10');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('26', '6', '3', 'officerbill from New York', 'Hazy yellow straw with a thin tan head that quickly dissolves into a ring.
...
This is better than a shandy and a great summer beer. At $9.99/6 it will be a staple.', '2020-06-18');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('26', '3', '3', 'jockstrappy from Pennsylvania', 'Pours a cloudy gold with a small yet creamy white head, doesn’t lace too much.
...
Slightly dry but quenching at the same time.
Good summer beer, not great, but I’d buy it again without hesitation.', '2020-06-13');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('26', '4', '3', 'MikeWard from Pennsylvania', ' got a 6pck of this beer from my local meijer store.
...
The mouthfeel was lighter in body with good carbonation. Overall its a decent beer.', '2020-04-17');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('27', '5', '4', 'gopens44 from Virginia', 'Pours a clear amber. Not much foam. Mild hoppy aroma. The taste however is far from mild. Very strong.
Almost like whiskey. Bitter syrupy finish.
Tastes like the lake monster pissed it out, but in a good way.', '2018-06-16');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('27', '6', '4', 'Explorer_Bill from Kentucky', 'Amazing DIPA. Served on tap in a shaker pint.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('27', '3', '5', 'jkblr from Indiana', 'Poured from a 12 OZ bottle into a pint glass.
The appearance is a cloudy gold color with a thick medium-sized white head.
The aroma is bread, malt and fruit. The taste follows the nose.', '2018-02-22');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('28', '4', '5', 'MoMaMe from Maryland', 'Poured from 12oz bottle into .5L stein. Clear bright orange/amber.
...
I enjoyed this beer and would seek it out again. One of the better American O-fests Ive come across.', '2020-10-16');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('28', '5', '4', 'mikeinportc from New York', 'A hearty Oktoberfest.
Very well done.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('28', '6', '4', 'crazyspicychef from Pennsylvania', 'Pours a light amber with white head. Some graham cracker crust aroma,
but it isnt particularly strong. Theres a lot of Honey Maid graham cracker/bready character. Honey wheat bread.
Its dry with some semblance of richness and enough hop character to break that up. Decent American Oktoberfest.', '2020-10-04');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('29', '3', '4', 'neenerzig from Ohio', 'Poured out of a 12 oz. can into one of my stange glasses,
...
Has a clean finish. A good beer and a good representation of this style I feel.', '2020-10-04');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('29', '4', '5', 'WoodBrew from Ohio', 'My Billet sons father gave me a 6pck of this beer.
...
The mouthfeel was lighter in body with good carbonation. Overall it is a solid beer.', '2020-09-26');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('29', '5', '5', 'BB1313 from Ohio', 'Pours golden with nice clarity; small white head that falls leaving nice retention and nice lacing. The aromas have hints of orange along with some mushrooms.
...
Mouthfeel is light with moderate carbonation. Its smooth and easy to drink.', '2020-09-18');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('30', '6', '4', 'MeanMotaScootah from California', 'I really really love this beer - although not sure if it is technically an IPA, the IBUs seem a bit low.
...
Mouthfeel is very smooth, creamy and enjoyable. This is a great IPA for people who say they dont like IPAs.', '2021-04-10');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('30', '3', '4', 'jwc215 from Arizona', 'Pours golden with a white head that is fizzy, but holds up to a lasting thin cover.
A bit of lacing sticks.The smell is of mango and passionfruit with musty, grassy and citric hops.
The mango and passionfruit enhance without overwhelming.', '2021-04-02');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('30', '4', '4', 'Mister_Faucher from Washington', 'Clear bright golden color, nice off-white head that slowly recedes, moderate amount of lacing. Very active carbonation streaming as it sits.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('31', '5', '4', 'PathofChaos from Maryland', 'From a bottle, pours as a haze deep copper with a thin off-white head plus loads of carbonation.
Aromas of caramel and grapefruit. Wow, loads of bitter hops and sweet malts with a citrus/grapefruit kick.
This is a great occasional beer. Great because it is balanced enough, hops vs malt, that one can appreciate the added citrus,
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('31', '6', '5', 'HoppingMadMonk from New Jersey', 'Been looking to review this one for a while. 
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('31', '3', '5', 'DDiFran from Ohio', 'Deep rich amber with a thick head that laces nicely. Dank hops smell.
Toasty malt body with a sharp hop bite. Best of both worlds. Look forward to this one every fall', '2020-10-02');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('32', '4', '3', 'yoyoyo345 from Ohio', 'Pretty good Oatmeal Stout!!!! Pours a dense dark brown color with no light coming through.
...
Not outstanding but solid enough. A very typical, smooth Oatmeal Stout.', '2021-02-23');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('32', '5', '2', 'SHDoyle from Ohio', 'Oh my gosh. This sounded like it should taste amazing.
But it just tastes like fake smoke flavor. I had to give it away to someone else because it honestly grossed me out.
And I love stouts. This was just an incredible disappointment.', '2021-2-13');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('32', '6', '2', 'MikeWard from Pennsylvania', 'Color is brown and somewhat light for a stout. 
...
Overall: 3.75 (This beer is good but I would not likely drink it again) Decent all around stout but nothing outrageous.
I wouldnt go out of my way to find it as there are likely better options.', '2021-01-07');

INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('33', '3', '4', 'guckymeister from Ohio', 'Great Lakes brings the honey to the Christmas Ale party.
...
INSERT INTO reviews (beer_id, user_id, rating, review_title, review_body, date_of_review)
VALUES ('33', '4', '4', 'Breviewer from North Carolina', 'Pours red with tall, long lasting,
...
Taste is of herbal hops, caramel malt, spices and red fruit. Finish is long and spicy. Nice brew.', '2020-11-27');
